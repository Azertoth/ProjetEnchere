...
public class Utilisateur {
	...
	public static int getCptUtilisateur() {
		return cptUtilisateur;
	}

	public static void setCptUtilisateur(int cptUtilisateur) {
		Utilisateur.cptUtilisateur = cptUtilisateur;
	}
	...
	public String toString() {
		return "Utilisateur [noUtilisateur=" + noUtilisateur + ", pseudo=" + pseudo + ", nom=" + nom + ", prenom="
				...
				+ ", administrateur=" + administrateur + ", listeArticleVendu=" + listeArticleVendu + "]";
	}
